      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ url('interaction') }}" class="nav-link @php echo (request()->segment(1)=='interaction')?'active':'' @endphp">
            ...
            <li class="nav-item">
              <a href="{{ url('customers') }}" class="nav-link @php echo (request()->segment(1)=='customers')?'active':'' @endphp">
                <i class="nav-icon fas fa-th"></i>
                <p>
