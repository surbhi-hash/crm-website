...
<input type="radio" class="form-check-input" id="" name="gender" value="Male" {{ $company->gender == 'Male' ? 'checked' : '' }}>Male 
  <label class="form-check-label" for="radio2"></label>&nbsp;&nbsp;&nbsp;&nbsp;
  <input type="radio" class="form-check-input" id="" name="gender"   value="Female" {{ $company->gender == 'Female' ? 'checked' : '' }}>Female 
  <label class="form-check-label" for="radio2"></label>
...
<textarea type="textarea" name="message" class="form-control" >{{ $company->message }}</textarea>
@error('sms')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
...
<select name="country" class="form-control" value="{{ $company->country }}">
    <option></option>
...
<input type="number" name="mobile" class="form-control" value="{{ $company->mobile }}">
@error('mobile')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
