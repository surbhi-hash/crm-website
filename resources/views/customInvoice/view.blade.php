...
@php
                ...
                <div class="table-responsive">
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        <th>Total:</th>
                        <td>$@php $totalAmount = ($taxAmount)+($subtotal1);@endphp {{ $totalAmount }}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            @if(empty($rws->inVoice))
            <form action="{{ url('custominvoice-generate') }}" method="post">
              @csrf
              <input type="hidden" name="nid" value="{{ $rws->bid }}">
            ...
            @else
            <a target="_blank" href="{{ url('custominvoice/') }}/{{$rws->inVoice}}.pdf" class="btn btn-primary float-right" style="margin-right: 5px;">
